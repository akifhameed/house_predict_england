          ...
          <div className="bg-surface-container-lowest rounded-2xl p-10 shadow-xl">
            ...
            <div className="text-center mb-8">
              <div className="w-14 h-14 rounded-2xl bg-primary flex items-center justify-center mx-auto mb-4">
                <span className="material-symbols-outlined text-on-primary text-3xl">lock_open</span>
              </div>
              <h1 className="font-headline text-3xl font-extrabold text-primary">Welcome back</h1>
              <p className="text-on-surface-variant text-sm mt-2">
                Sign in to view and save your valuations
              </p>
            </div>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-xs text-on-surface-variant font-semibold">or sign in with email</span>
              <div className="flex-1 h-px bg-outline-variant" />
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-secondary text-on-secondary py-4 rounded-xl font-bold text-base hover:opacity-90 active:scale-95 transition-all disabled:opacity-60 flex items-center justify-center gap-2"
              >
                {loading
